...
OUT4   BSR    OUT2A4
       JSR    OUT2BY
       LEAX   1,X      ;SKIP TO NEXT BYTE IN STACK
       LEAX   1,X      ;SKIP TO NEXT BYTE IN STACK
       RTS
...
DELIM  RMB    1        ;CHARACTER(S) PERMISSTED AS VALID COMMAND/MODIFIER DELIMITER
...
OUTFLG RMB    1        ;ALTERNATE OUTPUT DESTINATON FLAG
