...
;THE "EXTRA" CHAR "1" IS COMPENSATED FOR BY THE PROMPT CHAR ON THE PRECEEDING LINE
...
;ON THE INPUT LINE
;THE CURRENT CHARACTEER IS IGNORED IF THE SCANNING POINTER IS AT THE
...
;AGAINST THE DELIMITER(S) SPECIFIED BY VARIABLE DEIM
;ACCB & IX ARE PRESERVED
...
;TEST IF CHAR IS A TO 9 INCLUSIVVE
       CMPB   #'A'
       BLT    DLMYES
       CMPB   #'Z'
       BLE    DLMNO
...
;E.G., 100:105 IS EQUIVALNT TO 100!5
...
;*****
;GOOT NUMBER - SCAN WAS SUCCESSFUL
...
;**
;LEFT SHIFT THE 3 BYTE NUMBER 1 BT
LEFSHF ASL    NUMBLO
       ROL    NUMBHI
       ROLA
       RTS
...
TOACIA PSHA            ;SAVE CHAR
       LDAA   #2       ;GET ACIA TRANSMIT REG STATUS BUT
...
NMIVEC DS     2        ;NON-MASKABLE UNTERRUPT ADDRESS POINTER
...
DELIM  DS     1        ;CHARACTER(S) PERMISSTED AS VALID COMMAND/MODIFIER DELIMITER
...
OUTFLG DS     1        ;ALTERNATE OUTPUT DESTINATON FLAG
